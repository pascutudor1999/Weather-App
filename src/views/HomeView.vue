<template>
  <main class="container text-white">
    <div class="pt-4 mb-8 relative">
      ...
      <p v-if="!serveError && mapSearchResults.length === 0"
      >
...
const mapBoxAPIKey = "pk.eyJ1IjoicGFzY3V0dWRvcjE5OTkiLCJhIjoiY2xldmMzcWk5MXl6ajNxcDRlMzdsYzU3eSJ9.AkzxtaSH_WVX-jrLt8B2FA";
